...
app.config['MYSQL_USER'] = 'Co2tYvr06H'
app.config['MYSQL_PASSWORD'] = 'Oeti2fYFOR'
app.config['MYSQL_DB'] = 'Co2tYvr06H'
mysql = MySQL(app)
app.secret_key = 'a'
...
def cart_checkout():
    if request.method == 'POST':
        ...
        for i in range(count):
            ...
            if resq <= 0:
                prod = cart[i][3]
                sgemail = Mail(from_email = 'nidhijain39109@gmail.com',
                ...
                try:
                    sg = SendGridAPIClient('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')
